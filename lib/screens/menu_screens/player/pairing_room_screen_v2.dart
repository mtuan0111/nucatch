...
class PairingRoomScreenV2 extends StatefulWidget {
  final bool isHost;
  final String? roomCode;

  const PairingRoomScreenV2({
    super.key,
  ...
  @override
  State<PairingRoomScreenV2> createState() => _PairingRoomScreenV2State();
}

class _PairingRoomScreenV2State extends State<PairingRoomScreenV2> {
