...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get selectLevelMessage => 'Elige el nivel que quieres jugar. Cuanto más alto sea el nivel, más difícil será.';
  ...
  @override
  String get thankYouMessage => 'Gracias por jugar nuestro juego. Esperamos que lo hayas disfrutado. Si tienes algún comentario o sugerencia, no dudes en hacérnoslo saber.';
  ...
  @override
  String get connectWithUsMessage => 'Si tienes alguna pregunta o comentario, no dudes en contactarnos en nuestras redes sociales.';

  @override
  String get introductionContent => 'NuCatch es un juego mental divertido y atractivo diseñado para agudizar tu memoria y mejorar el enfoque. Desafíate a atrapar números rápidamente en poco tiempo, ayudándote a recordar cosas como OTPs, números de teléfono, cumpleaños y más. ¡Disfruta de la experiencia y mejora tus habilidades de memoria!';
  ...
  @override
  String get confirmRestart => '¿Estás seguro de que quieres reiniciar el juego?';
  ...
  @override
  String get difficultyEasyDescription => 'Genera un número aleatorio con un nivel ligeramente aumentado para desafíos simples.';

  @override
  String get difficultyMediumDescription => 'Produce una expresión de cálculo de suma/resta para una dificultad moderada.';

  @override
  String get difficultyHardDescription => 'Crea una expresión de cálculo de multiplicación/división para una dificultad avanzada.';

  @override
  String get difficultyExtremeDescription => 'Selecciona aleatoriamente entre generar un cálculo complejo de suma/resta, un número aleatorio de mayor nivel o un cálculo de multiplicación/división para la experiencia más desafiante.';
  ...
  @override
  String get confirmChangeDifficulty => 'Tu turno se reiniciará. ¿Estás seguro de que quieres cambiar la dificultad?';
  ...
  @override
  String get dailyDescription => 'Clasificaciones basadas en turnos registrados hoy.';

  @override
  String get weekly => 'En una semana';

  @override
  String get weeklyDescription => 'Clasificaciones basadas en turnos registrados en los últimos 7 días.';

  @override
  String get allTime => 'Todo el tiempo';

  @override
  String get allTimeDescription => 'Clasificaciones basadas en todos los turnos registrados.';
  ...
  @override
  String get forceUpdateMessage => 'Esta actualización es necesaria para continuar usando la aplicación. Por favor actualiza ahora.';
  ...
  @override
  String get tapToCheckUpdates => 'Toque el botón de abajo para buscar actualizaciones de la aplicación.';
  ...
  @override
  String get soloModeDescription => 'Juega solo y desafíate a superar tu puntuación más alta';

  @override
  String get combatMode => 'Modo Combate';

  @override
  String get combatModeDescription => 'Juega con otro jugador a través de conexión Bluetooth y tómense turnos';

  @override
  String get createRoom => 'Crear Sala';

  @override
  String get createRoomDescription => 'Organiza un nuevo juego y espera a que otro jugador se una';

  @override
  String get joinRoom => 'Unirse a Sala';

  @override
  String get joinRoomDescription => 'Ingresa un código de sala para unirte a un juego existente';
  ...
  @override
  String get bluetoothPermissionMessage => 'El Modo Combate requiere permisos de Bluetooth para conectarse con otros jugadores. Por favor otorga permisos de Bluetooth en la configuración de tu dispositivo.';

  @override
  String get bluetoothPermissionPermanentlyDeniedMessage => 'Los permisos de Bluetooth fueron denegados permanentemente. Para usar el Modo Combate, necesitas habilitar los permisos de Bluetooth en la configuración de tu dispositivo.\n\nPor favor ve a Configuración > NuCatch > Permisos y habilita Bluetooth.';

  @override
  String get bluetoothDisabled => 'Bluetooth Desactivado';

  @override
  String get bluetoothDisabledMessage => 'El Modo Combate requiere que el Bluetooth esté activado. Por favor activa el Bluetooth en la configuración de tu dispositivo.';
  ...
  @override
  String get confirmEndCombat => '¿Estás seguro de que quieres terminar este juego? Tu oponente ganará.';
  ...
  @override
  String get greetingEarthDay => '¡Feliz Día de la Tierra! ¡Protege nuestro planeta!';
  ...
  @override
  String get advertisingRoomWaiting => '¡Anunciando sala! Esperando oponente...';

  @override
  String get opponentJoinedReady => '¡Oponente unido! Presiona Listo cuando estés preparado.';
  ...
  @override
  String get pressReadyWhenPrepared => 'Presiona Listo cuando estés preparado para comenzar.';
  ...
  @override
  String get waitingForHostToSelectDifficulty => 'Esperando a que el anfitrión seleccione la dificultad...';

  @override
  String get failedToInitializeNearby => 'No se pudo inicializar Nearby Connections. Por favor otorga permisos de ubicación.';
  ...
  @override
  String get advertisingRoomStatus => 'Anunciando sala...\nEsperando que el oponente descubra y conecte.';

  @override
  String get opponentConnectedStatus => '¡Oponente conectado!\nPresiona Listo cuando ambos jugadores estén listos.';

  @override
  String get bothPlayersReadyStatus => '¡Ambos jugadores listos! Iniciando juego...';
  ...
  @override
  String get makeSureFriendHosting => 'Asegúrate de que un amigo esté siendo anfitrión\ny ambos dispositivos estén cerca';
  ...
  @override
  String get distanceWarning => 'Asegúrate de que los dispositivos estén a menos de 10 metros de distancia';
  ...
  @override
  String get tourWelcomeDesc => '¡Bienvenido! Este breve recorrido te ayudará a comenzar sin problemas con **NuCatch**. Te mostraremos todas las **características principales** para que puedas sumergirte y empezar a jugar de inmediato. ¡Comencemos!';

  @override
  String get tourStartTitle => 'Inicio - Comienza tu Juego';

  @override
  String get tourStartDesc => 'Toca el **botón Comenzar** para iniciar. Luego elegirás entre **Modo Solo** para desafíos matemáticos individuales, o **Modo Combate** para batallas multijugador en tiempo real por **Bluetooth**. ¡Exploremos ambas opciones!';

  @override
  String get tourSoloTitle => 'Modo Solo - Juega Solo';

  @override
  String get tourSoloDesc => 'En **Modo Solo**, desafíate con ecuaciones matemáticas! Elige entre **4 niveles de dificultad** (Fácil a Extremadamente Difícil). Comienzas con **3 vidas** - cada respuesta incorrecta o tiempo agotado cuesta 1 vida. ¡**Mayor dificultad** significa más puntos! Ahora veamos la opción multijugador.';

  @override
  String get tourCombatTitle => 'Modo Combate - Multijugador Bluetooth';

  @override
  String get tourCombatDesc => '¡El **Modo Combate** te permite batallar con un amigo vía **Bluetooth**! **Dos jugadores** se turnan resolviendo ecuaciones - **no se necesita WiFi**, solo mantente dentro de **10 metros**. El anfitrión juega primero inicialmente, pero en las revancha el perdedor va primero. Tienes dos formas de iniciar una partida:';

  @override
  String get tourCreateRoomTitle => 'Modo Combate → Crear Sala';

  @override
  String get tourCreateRoomDesc => 'Primera opción: **Crear Sala** te hace el **anfitrión**! Después de otorgar **permisos de Bluetooth**, esperarás a que un invitado se una a tu sala, luego elegirás el **nivel de dificultad**. Como anfitrión, **juegas primero** en la partida inicial. O puedes unirte al juego de alguien más:';

  @override
  String get tourJoinRoomTitle => 'Modo Combate → Unirse a Sala';

  @override
  String get tourJoinRoomDesc => 'Segunda opción: **Unirse a Sala** te hace el **invitado**! Después de otorgar permisos, **escanearás** salas cercanas, seleccionarás una y tocarás **listo**. El anfitrión elige la dificultad, y **jugarás segundo** en la partida inicial. Ahora revisemos las otras características del menú.';

  @override
  String get tourLeaderboardTitle => 'Mejor Puntuación - Clasificaciones';

  @override
  String get tourLeaderboardDesc => '¡Rastrea tu progreso aquí! Ve **clasificaciones globales**, tus **récords personales** y **estadísticas** incluyendo juegos jugados, tasa de victorias, precisión y puntuaciones por nivel de dificultad. Compara con amigos y observa cómo mejoras con el tiempo. Finalmente, visitemos Configuración.';

  @override
  String get tourSettingsTitle => 'Configuración - Personalizar';

  @override
  String get tourSettingsDesc => '¡Personaliza todo aquí! Cambia tu **nombre de usuario**, selecciona un **tema**, ajusta **sonido/música**, elige tu **idioma** y administra la **configuración de privacidad**. Puedes reiniciar este tour en cualquier momento desde aquí. ¡Eso es todo - estás listo para jugar!';
  ...
  @override
  String get tourResetMessage => 'El tour ha sido reiniciado. Regresa al menú principal para comenzar.';
}
